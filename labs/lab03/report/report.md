...
2. Тип начертания:
  ...
  Полужирное начертание: **ваш текст**
  Курсивное начертание: *ваш текст*
  Полужирное + курсивное начертание: ***ваш текст***
...
4. Списки:
  ...
  Маркированный (неупорядоченный) список (Обозначаем элементы списка тире):
...
5. Гиперссылки:
  ...
  [Название ссылки](URL-адрес сайта или файл, на который даётся ссылка)
...
7. Формулы и их отображение:
  ...
  H~2~0
  Чтобы поставить степень, пишем:
  2^10^
  Знакомая нам со школы формула (основное тригонометрическое тождество) будет выглядеть так:
  $\sin^2 (x) + \cos^2 (x) 1$
  
8. Оформление картинок:

  Чтобы вставить в текст иллюстрацию, нужно использовать следующий синтаксис (рис. @fig:001):
![Подпись к изображению](путь к изображению){#fig:001 width=70%} - fig совпадают.
...
# Выполнение лабораторной работы
  ...
  Для начала я перешла в каталог с лабораторной работой №2 (рис. @fig:002).

![Переход в каталог с лабораторной работой № 2](image/placeimg_800_600_tech.jpg){#fig:002 width=70%}
...
![Makefile в папке с отчётом в формате .md](image/placeimg_800_600_tech.jpg){#fig:003 width=70%}
...
![Внесение изменений в шаблон](image/placeimg_800_600_tech.jpg){#fig:004 width=70%}
![Отчёт по выполняемым действиям](image/placeimg_800_600_tech.jpg){#fig:005 width=70%}
  ...
  После завершения оформления отчёта я скомпилировала их, использовав команду make (рис. @fig006):
  
![Компиляция файла .md в файлы .docx, .pdf](image/placeimg_800_600_tech.jpg){#fig:006 width=70%}

  После завершения оформления отчёта я скомпилировала их, использовав команду make (рис. @fig007):
  
![Скомпилированные файлы в форматах .docx, .pdf](image/placeimg_800_600_tech.jpg){#fig:007 width=70%}


  Затем отправила полученные файлы на github посредством локального репозитория (рис. @fig008):
  
![Отправка файлов на Github посредством локального репозитория](image/placeimg_800_600_tech.jpg){#fig:008 width=70%}
